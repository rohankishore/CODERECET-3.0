...
const Countdown = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex justify-between md:justify-center items-center w-full md:gap-8 lg:gap-[60px]">
          {/* Days */}
          <div className="flex flex-col items-center justify-center">
            <div className="font-thomeo text-5xl sm:text-7xl md:text-8xl lg:text-[180px] xl:text-[200px] text-custom-white leading-none">
              {timeLeft.days}
            </div>
            <div className="font-tactic_sans text-[10px] sm:text-sm md:text-base lg:text-[24px] xl:text-[29px] text-custom-white leading-none mt-2 lg:mt-6 tracking-widest">
              DAYS
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center pb-6 sm:pb-8 lg:pb-[45px] gap-2 lg:gap-[28px]">
            <div className="w-2 h-2 sm:w-3 sm:h-3 lg:w-5 lg:h-5 rounded-full bg-custom-secondary"></div>
            <div className="w-2 h-2 sm:w-3 sm:h-3 lg:w-5 lg:h-5 rounded-full bg-custom-secondary"></div>
          </div>
