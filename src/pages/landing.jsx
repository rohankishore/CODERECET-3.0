...
Add overflow-x-hidden pointer-events-none select-none z-10"
          ...
          <div className="bg-custom-black border-2 border-custom-secondary rounded-xl p-6 w-[90vw] max-w-[500px] relative z-10" data-blendy-to="location">
            <div>
              ...
              <div className="rounded-lg overflow-hidden" style={{ filter: 'invert(90%) hue-rotate(180deg)' }}>
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15864.27996839653!2d76.89328094100948!3d8.545851629468523!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b05bec79541c519%3A0x98324eb5aafb3778!2sCollege%20of%20Engineering%20Trivandrum%20(CET)!5e1!3m2!1sen!2sin!4v1770842775967!5m2!1sen!2sin"
                  width="100%"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen
      ...
      {showCalendar && createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center animate-[fadeIn_0.3s_ease-out]">
          <div
            className="absolute inset-0 bg-black/60 animate-[fadeIn_0.3s_ease-out]"
            onClick={() => { blendyRef.current?.untoggle('calendar', () => setShowCalendar(false)); }}
          />
          <div className="bg-custom-black border-2 border-custom-secondary rounded-xl p-6 w-[90vw] max-w-[400px] relative z-10" data-blendy-to="calendar">
            <div>
              <div className="flex justify-between items-center mb-4">
