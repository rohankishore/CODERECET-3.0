        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-start gap-8">
          <div className="flex flex-col gap-6 w-full md:w-1/2 items-center md:items-start">
            ...
            <div className="flex gap-4 sm:gap-8 mt-6 sm:mt-8 font-tactic_sans justify-center md:justify-start">
              <a href="https://twitter.com/coderecet" target="_blank" rel="noopener noreferrer"><img src="/assets/footer/twitter logo.png" alt="Twitter" className="w-10 h-10" /></a>
              <a href="https://facebook.com/coderecet" target="_blank" rel="noopener noreferrer"><img src="/assets/footer/facebook logo.png" alt="Facebook" className="w-10 h-10" /></a>
              <a href="https://discord.gg/coderecet" target="_blank" rel="noopener noreferrer"><img src="/assets/footer/Discord logo.png" alt="Discord" className="w-10 h-10" /></a>
              <a href="https://linkedin.com/company/coderecet" target="_blank" rel="noopener noreferrer"><img src="/assets/footer/Linkedin logo.png" alt="LinkedIn" className="w-10 h-10" /></a>
              <a href="https://github.com/coderecet" target="_blank" rel="noopener noreferrer"><img src="/assets/footer/Github logo.png" alt="GitHub" className="w-10 h-10" /></a>
            </div>
          </div>
          <div className="flex flex-col items-center md:items-end w-full md:w-1/2 gap-4 sm:gap-6 font-tactic_sans mt-8 md:mt-0">
            ...
            <img src="/assets/logo/tinkerhub.png" className="w-32 sm:w-48 h-auto mb-2 filter invert brightness-100" alt="Tinkerhub" />
            <img src="/assets/logo/IET.png" className="w-32 sm:w-48 h-auto filter invert brightness-100" alt="IET" />
          </div>
        </div>
      </div>
    </footer>
